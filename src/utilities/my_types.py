...
Faculty = namedtuple('Faculty', ['id', 'name', 'user_id'])
...
Rasp = namedtuple('Rasp', ['id', 'subject_id', 'professor_id','type', 'group', 'duration', 'mandatory_in_semester_ids',  'optional_in_semester_ids', 'needs_computers', 'total_groups', 'fix_at_room_id','random_dtstart_weekday','fixed_hour','rrule', 'user_id'])
