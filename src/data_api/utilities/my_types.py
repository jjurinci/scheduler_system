...
Rasp = namedtuple('Rasp', ['id', 'subjectId', 'professorId','type', 'group', 'duration', 'mandatory', 'needsComputers', 'totalGroups', 'color', 'fix_at_roomId','FREQ','INTERVAL','BYWEEKDAY','DTSTART','UNTIL','rrule_dates','userId'])
